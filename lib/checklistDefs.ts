...
export const CHECK_DEFS: CheckDef[] = [
  ...
  { id: "spf_check", label: "SPF record configured", group: "site_health",
    description: "Checks the domain has an SPF DNS record, reducing the risk of attackers spoofing emails from this domain." },
  { id: "dmarc_check", label: "DMARC record configured", group: "site_health",
    description: "Checks the domain has a DMARC policy, which tells email providers what to do with spoofed messages." },
  { id: "mx_records_check", label: "MX records configured", group: "site_health",
    description: "Checks the domain has mail-exchange (MX) DNS records if it's expected to receive email." },
  ...
  { id: "dns_health_check", label: "Overall DNS/email health", group: "site_health",
    description: "A combined summary of the SPF, DMARC, and MX results above, for a quick at-a-glance view of email security." },
